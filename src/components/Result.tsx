...
const StyledConstructionLabel = styled.p<ConstructionLabelProps>`
  ...
  background-color: ${(props) => {
    if (props.construction === "pu") {
      return props.theme.colors.colorPrimaryLight;
    }
    if (props.construction === "epoxy") {
      return props.theme.colors.colorSecondary;
    }
    if (props.construction === "soft") {
      return props.theme.colors.colorMintGreen;
    }
